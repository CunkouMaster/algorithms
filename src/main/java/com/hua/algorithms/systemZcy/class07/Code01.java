package com.hua.algorithms.systemZcy.class07;

import com.hua.example.class07.Code01_CoverMax;
...
public class Code01 {
	...
	public static int maxCover2(int[][] m) {
		...
		//根据start从小到大排序
		PriorityQueue<Line> lines = new PriorityQueue<>(new StartComparator());
		for(int i = 0;i<m.length;i++){
			lines.add(new Line(m[i][0], m[i][1]));
		}
